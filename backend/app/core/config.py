...
class Settings:
    ...
    CORS_ORIGINS = _parse_cors_origins(
        os.getenv(
            "CORS_ORIGINS",
            "http://localhost:5173,http://127.0.0.1:5173,https://email-threat-detecion1.vercel.app,https://email-threat-detection1.vercel.app,https://sih-2026-project-blush.vercel.app",
        )
    )
