import {
  ...
  ShieldCheck, Users, Activity, FileText, LogOut
} from 'lucide-react';
  ...
  return (
    <aside className="w-64 bg-[#080D14] border-r border-[#151D28] flex flex-col">
      ...
      <nav className="flex-1 p-4 space-y-6 overflow-y-auto">
        ...
        {isAdmin && (
            <div className="space-y-1">
            <p className="text-[10px] font-bold text-gray-500 uppercase px-4 mb-2 tracking-wider">Administration</p>
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `flex items-center gap-3 px-4 py-2 text-sm rounded ${
          isActive
            ? 'bg-[#151D28] text-cyan-400 border-l-2 border-cyan-400'
            : 'text-gray-400 hover:text-gray-200 hover:bg-[#101722]'
        }`
      }
    >
      <Icon size={16} />
